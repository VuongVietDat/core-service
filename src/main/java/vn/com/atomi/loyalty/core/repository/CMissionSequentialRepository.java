...
public interface CMissionSequentialRepository extends JpaRepository<CMissionSequential, Long> {
    ...
    @Query(value = """
            INSERT INTO C_CUST_MISSION_PROGRESS (CUSTOMER_ID, PARENT_ID,MISSION_ID,MISSION_TYPE,STATUS,ORDER_NO,GROUP_TYPE,START_DATE,END_DATE,TXN_ID)
            SELECT
                cms2.CUSTOMER_ID, cms2.PARENT_ID, cms2.MISSION_ID,
                cms2.MISSION_TYPE, cms2.STATUS,
                cms2.ORDER_NO, cms2.GROUP_TYPE,
            ...
            FROM (
                SELECT
                    ...
                    NVL(ORDER_NO, PRIOR ORDER_NO) ORDER_NO,'PENDING' STATUS,
                    (
    ...
    """, nativeQuery = true)
    List<Long> saveDataMissionToCustomer(String transId, String cifBank, Long chainId);
}