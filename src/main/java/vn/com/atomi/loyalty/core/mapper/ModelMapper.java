...
public interface ModelMapper {
    ...
    @Mapping(target = "genderName",
            source = "customer.gender",
            qualifiedByName = "findDictionaryName")
    @Mapping(target = "nationalityName",
    ...
    @Mapping(
            ...
            qualifiedByName = "findDictionaryName")
    CustomerOutput convertToCustomerOutput(Customer customer, @Context List<DictionaryOutput> dictionaryOutputs);
